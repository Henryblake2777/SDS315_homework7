...
If we were to take many samples from the population and make a 95% confidence interval for each one, we could expect the population mean to be contained in 95 percent of the intervals
